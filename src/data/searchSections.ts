...
export const STORE_SECTIONS: StoreSection[] = [
  {
    id: 'editing-designing-prompts',
    title: '50 One-Word “/” Prompts for Editing & Designing',
    subtitle: 'Ready-to-copy keywords for image transformation, lighting, aesthetics & social layouts',
    page: 'ai-prompts',
    sectionAnchor: '#editing-designing-section',
    badge: 'Editing & Designing',
    iconName: 'Palette',
    keywords: [
      'editing',
      'designing',
    ...
    description: 'Transform images and design assets instantly with 50 one-word slash commands across 5 styles.'
  },
  {
